...
import {Doughnut} from 'react-chartjs-2';//차트 가져오기
                ...
                datasets:[
                    {
                        ...
                        fill:false,
                        data:[Global.data.Global.TotalConfirmed,Global.data.Global.TotalDeaths,Global.data.Global.TotalRecovered]
                    }
                ]
            })
    }
    ...
    return (
        ...
        <div className="kr_Count_wrapper">
            ...
            <div className="kr_Count">
                <h3>확진자</h3>
                {GlobalConfirmed}
                <p><img src={UpArrow} alt="uparrow"></img>{GlobalNewConfirmed}</p>
            </div>
            <div className="kr_recovered_Count">
                <h3>격리해제</h3>
                {GlobalDeaths}
                <p><img src={UpArrow}alt="uparrow"></img>{GlobalNewRecover}</p>
                </div>
            <div className="kr_deaths_Count">
                <h3>사망자</h3>
                {GlobalRecover}
                <p><img src={UpArrow}alt="uparrow"></img>{GlobalNewDeaths}</p>
                </div>
            </div>
        </div>
